...
| <strong>logging_file_name: *str, None or 'uuid', defailt=None*</strong>                                    | Text file name to dump intermediate results of iterative process of model training. If None, then no logging is performed. For `'uuid'` the filename is set to an universally unique identifier, for example, `592541c44ae044b3a3f24119b1951e63.log`.|
